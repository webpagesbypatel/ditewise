  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between gap-4 border-b border-gray-200 bg-white/95 backdrop-blur-md px-6 shadow-sm">
      ...
      <div className="lg:hidden flex-shrink-0">
        <SidebarTrigger className="h-10 w-10 rounded-lg border border-gray-200 bg-white hover:bg-gray-50 transition-colors duration-200">
      ...
      {/* Spacer for balance */}
      <div className="hidden lg:block w-10 flex-shrink-0"></div>
    </header>
  )
}